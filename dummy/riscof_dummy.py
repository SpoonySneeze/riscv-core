...
class dummy(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","dummy")
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for dummy start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
